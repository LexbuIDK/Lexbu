...
const items = [
    { icon: 'fab fa-youtube', link: 'https://www.youtube.com/channel/UCGEQ_qp7WRh0o4eS-3CQBRQ' },
    //{ icon: 'fab fa-twitch', link: 'https://twitch.com/umutyzx' },
    { icon: 'fab fa-discord', link: 'https://discord.com/users/349217516968738837' },
    //{ icon: 'fab fa-instagram', link: 'https://instagram.com/umutxyp' },
    //{ icon: 'fab fa-facebook', link: 'https://facebook.com/umutxyp' },
    { icon: 'fab fa-github', link: 'https://github.com/lexbuidk' },
  ]
